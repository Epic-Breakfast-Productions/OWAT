...
# SCRAMBLING
plot(
  scramblingData$matrixSize[scramblingData$nodeMode=="byte"],
...
plot(
  scramblingData$matrixSize[scramblingData$nodeMode=="bit"],
...
plot(
  descramblingData$matrixSize[descramblingData$nodeMode=="byte"],
...
plot(
  descramblingData$matrixSize[descramblingData$nodeMode=="bit"],
