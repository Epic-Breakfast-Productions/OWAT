...
public enum ScrambleMoves {
	...
	ROT_CLOCK	("6",RotateClock.OP,5, "\\s*("+RotateClock.OP+"|6)\\s*"+OP_SEP+"\\s*(-?1|-?2|-?3)\\s*"+ARG_SEP+"\\s*\\d+\\s*"+COORD_SEP+"\\s*\\d+\\s*"+ARG_SEP+"\\s*\\d+\\s*"+COORD_SEP+"\\s*\\d+\\s*"+MOVE_END+"\\s*"),
	ROT_CCLOCK	("7",RotateCounterClock.OP,5, "\\s*("+RotateCounterClock.OP+"|7)\\s*"+OP_SEP+"\\s*(-?1|-?2|-?3)\\s*"+ARG_SEP+"\\s*\\d+\\s*"+COORD_SEP+"\\s*\\d+\\s*"+ARG_SEP+"\\s*\\d+\\s*"+COORD_SEP+"\\s*\\d+\\s*"+MOVE_END+"\\s*");
