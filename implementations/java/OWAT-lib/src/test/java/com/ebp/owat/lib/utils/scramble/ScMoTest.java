...
public abstract class ScMoTest {
	...
	protected static final Collection<String> SLIDE_ROW = Arrays.asList("slr:100,399;"," slr : 100 , 399 ; ");
	protected static final Collection<String> SLIDE_COL = Arrays.asList("slc:100,399;"," slc : 100 , 399 ; ");
	protected static final Collection<String> ROT_CLOCK = Arrays.asList("rcl:1,1x2,3x4;"," rcl : 1 , 1 x 2 , 3 x 4 ; ");
	protected static final Collection<String> ROT_CCLOCK = Arrays.asList("rcc:1,1x2,3x4;"," rcc : 1 , 1 x 2 , 3 x 4 ; ");
