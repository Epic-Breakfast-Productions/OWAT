...
public class LongLinkedListTestModels {
	...
	public static final Collection<Long> testingArray = Arrays.asList(0L, 1L, 2L, 3L);
	public static final Collection<Long> fullTestingArray = Arrays.asList(0L, 1L, 2L, 3L, 4L);
}
